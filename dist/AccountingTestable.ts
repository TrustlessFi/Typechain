...
export interface AccountingTestableInterface extends ethers.utils.Interface {
  functions: {
...
export interface AccountingTestable extends BaseContract {
  ...
  functions: {
    ...
    getUIs(
      ...
      [UserInterfaceStructOutput[]] & { uis: UserInterfaceStructOutput[] }
    >;
  ...
  getUIs(
    ...
    overrides?: CallOverrides
  ): Promise<UserInterfaceStructOutput[]>;
