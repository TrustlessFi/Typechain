...
export interface Multicall2 extends BaseContract {
    ...
    functions: {
        ...
        blockAndAggregate(calls: CallStruct[], overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        tryAggregate(requireSuccess: boolean, calls: CallStruct[], overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        tryBlockAndAggregate(requireSuccess: boolean, calls: CallStruct[], overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    };
    aggregate(calls: CallStruct[], overrides?: Overrides & {
