...
export declare type QuoteExactInputSingleParamsStruct = {
    tokenIn: string;
    tokenOut: string;
...
export declare type QuoteExactInputSingleParamsStructOutput = [
    string,
    string,
    BigNumber,
    number,
...
export declare type QuoteExactOutputSingleParamsStruct = {
    tokenIn: string;
    tokenOut: string;
    amount: BigNumberish;
    fee: BigNumberish;
...
export declare type QuoteExactOutputSingleParamsStructOutput = [
    string,
    string,
    BigNumber,
    number,
...
export interface QuoterV2Interface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "quoteExactInputSingle", values: [QuoteExactInputSingleParamsStruct]): string;
    encodeFunctionData(functionFragment: "quoteExactOutput", values: [BytesLike, BigNumberish]): string;
    encodeFunctionData(functionFragment: "quoteExactOutputSingle", values: [QuoteExactOutputSingleParamsStruct]): string;
...
export interface QuoterV2 extends BaseContract {
    ...
    functions: {
        ...
        quoteExactInputSingle(params: QuoteExactInputSingleParamsStruct, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        quoteExactOutput(path: BytesLike, amountOut: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        quoteExactOutputSingle(params: QuoteExactOutputSingleParamsStruct, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        quoteExactInputSingle(params: QuoteExactInputSingleParamsStruct, overrides?: CallOverrides): Promise<[
            BigNumber,
            BigNumber,
            number,
            BigNumber
        ...
        quoteExactOutputSingle(params: QuoteExactOutputSingleParamsStruct, overrides?: CallOverrides): Promise<[
            BigNumber,
            BigNumber,
            number,
            BigNumber
