...
export interface RewardsTestableInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [MintParamsStruct, BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [DecreaseLiquidityParamsStruct, BigNumberish]
  ): string;
  ...
  encodeFunctionData(
    ...
    values: [IncreaseLiquidityParamsStruct, BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [PoolPositionStruct, BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface RewardsTestable extends BaseContract {
  ...
  functions: {
    ...
    calculateUpdatedLiquidityPosition(
      _pt: PoolPositionStruct,
      rs: RewardStatusStruct,
      timeNow: BigNumberish,
      overrides?: CallOverrides
    ): Promise<
      [PoolPositionStructOutput, BigNumber] & {
