...
export interface AccountingTestableInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "__addPositionToIndex", values: [string, BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "__addPositionToIndex", data: BytesLike): Result;
...
export interface AccountingTestable extends BaseContract {
    ...
    functions: {
        __addPositionToIndex(owner: string, nftID: BigNumberish, overrides?: Overrides & {
    ...
    validUpdate(arg0: BytesLike, overrides?: CallOverrides): Promise<boolean>;
    callStatic: {
        __addPositionToIndex(owner: string, nftID: BigNumberish, overrides?: CallOverrides): Promise<void>;
