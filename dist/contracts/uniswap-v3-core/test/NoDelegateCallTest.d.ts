...
export interface NoDelegateCallTestInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "callsIntoNoDelegateCallFunction" | "canBeDelegateCalled" | "cannotBeDelegateCalled" | "getGasCostOfCanBeDelegateCalled" | "getGasCostOfCannotBeDelegateCalled"): FunctionFragment;
