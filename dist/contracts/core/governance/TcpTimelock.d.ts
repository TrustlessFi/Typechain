...
export declare namespace TcpTimelock {
...
export interface TcpTimelockInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "GRACE_PERIOD" | "MAXIMUM_DELAY" | "MINIMUM_DELAY" | "admin" | "cancelTransaction" | "delay" | "deployer" | "executeTransaction" | "getAdmin" | "guardian" | "init" | "queueTransaction" | "queuedTransactions" | "setDelay" | "validUpdate"): FunctionFragment;
