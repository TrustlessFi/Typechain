...
export declare namespace TcpGovernorAlpha {
    type ConstructorParamsStruct = {
        TcpTimelock: PromiseOrValue<string>;
        Tcp: PromiseOrValue<string>;
        Guardian: PromiseOrValue<string>;
        VoteBlockCount: PromiseOrValue<BigNumberish>;
...
export interface TcpGovernorAlphaInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "BALLOT_TYPEHASH" | "DOMAIN_TYPEHASH" | "INFLATION_PERCENTAGE" | "__abdicate" | "cancel" | "castVote" | "castVoteBySig" | "claimVotingRewards" | "countVotingRewards" | "execute" | "getActions" | "getProposals" | "getProposalsVoterInfo" | "getReceipt" | "governor" | "guardian" | "implementsVotingRewardsWithToken" | "latestProposalIds" | "name" | "proposalCount" | "proposalMaxOperations" | "proposalThreshold" | "proposals" | "propose" | "queue" | "quorumVotes" | "state" | "timelock" | "votingDelay" | "votingPeriod" | "votingPeriodBlocks" | "votingToken"): FunctionFragment;
