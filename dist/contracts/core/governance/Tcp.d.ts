...
export interface TcpInterface extends utils.Interface {
    functions: {
    ...
    encodeFunctionData(functionFragment: "getTokenNFTIcon", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "getTokenNFTIcon", data: BytesLike): Result;
...
export interface Tcp extends BaseContract {
