...
export interface IHueInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "allowance" | "approve" | "balanceOf" | "burnFrom" | "burnReserves" | "distributeReserves" | "mintTo" | "reserves" | "totalSupply" | "transfer" | "transferFrom"): FunctionFragment;
...
export interface IHue extends BaseContract {
    ...
    functions: {
        ...
        mintTo(account: PromiseOrValue<string>, countTokensToMint: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        mintTo(account: PromiseOrValue<string>, countTokensToMint: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        reserves(overrides?: CallOverrides): Promise<BigNumber>;
        totalSupply(overrides?: CallOverrides): Promise<BigNumber>;
