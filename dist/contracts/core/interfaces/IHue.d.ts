...
export interface IHue extends BaseContract {
    ...
    functions: {
        ...
        mintTo(account: string, countTokensToMint: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        mintTo(account: string, countTokensToMint: BigNumberish, overrides?: CallOverrides): Promise<void>;
        reserves(overrides?: CallOverrides): Promise<BigNumber>;
        totalSupply(overrides?: CallOverrides): Promise<BigNumber>;
