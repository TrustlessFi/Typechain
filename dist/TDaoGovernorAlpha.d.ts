...
export interface TDaoGovernorAlpha extends BaseContract {
    ...
    functions: {
        ...
        claimUnderlyingVotingRewards(proposalID: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        claimUnderlyingVotingRewards(proposalID: BigNumberish, overrides?: CallOverrides): Promise<void>;
