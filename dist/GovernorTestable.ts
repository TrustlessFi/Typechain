...
export type ProtocolDataStruct = {
  accounting: string;
  auctions: string;
...
export type ProtocolDataStructOutput = [
  string,
  string,
  string,
  string,
...
export interface GovernorTestableInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "increaseTCPAllocationOverride",
    values: [string, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "init",
    values: [ProtocolDataStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "maxTotalDailyRewardsAllocation",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setMockTcpAllocation",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "totalTcpAllocated",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export type ShutdownExecutedEvent = TypedEvent<[], {}>;
...
export interface GovernorTestable extends BaseContract {
  ...
  functions: {
    ...
    maxTotalDailyRewardsAllocation(
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
    ...
    setMockTcpAllocation(
      mockTcpAllocation: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
