...
export interface MarketTestableInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [DebtPositionStruct, SystemDebtInfoStruct, BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface MarketTestable extends BaseContract {
  ...
  functions: {
    ...
    updatePositionImpl(
      _position: DebtPositionStruct,
      sdi: SystemDebtInfoStruct,
      timeNow: BigNumberish,
      overrides?: CallOverrides
    ): Promise<
      [DebtPositionStructOutput, BigNumber] & {
  ...
  calculateInterest(
    ...
    _interestPortionToLenders: BigNumberish,
    overrides?: CallOverrides
  ): Promise<CalculatedInterestInfoStructOutput>;
