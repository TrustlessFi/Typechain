...
export interface IAccountingInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [BigNumberish, DebtPositionStruct]
  ): string;
  encodeFunctionData(
...
export type DebtPositionIndexingDisabledEvent = TypedEvent<[], {}>;

export type DebtPositionIndexingDisabledEventFilter =
  TypedEventFilter<DebtPositionIndexingDisabledEvent>;

export type PoolPositionIndexingDisabledEvent = TypedEvent<[], {}>;

export type PoolPositionIndexingDisabledEventFilter =
  TypedEventFilter<PoolPositionIndexingDisabledEvent>;

export type UIInitializedEvent = TypedEvent<
  [number, string, string],
  { interfaceID: number; kickbackDestination: string; ipfsHash: string }
>;

export type UIInitializedEventFilter = TypedEventFilter<UIInitializedEvent>;

export type UIRegisteredEvent = TypedEvent<
...
export type UIRegisteredEventFilter = TypedEventFilter<UIRegisteredEvent>;

export type UIsApprovedEvent = TypedEvent<[number[]], { uis: number[] }>;

export type UIsApprovedEventFilter = TypedEventFilter<UIsApprovedEvent>;

export type UIsDisapprovedEvent = TypedEvent<[number[]], { uis: number[] }>;

export type UIsDisapprovedEventFilter = TypedEventFilter<UIsDisapprovedEvent>;
...
export interface IAccounting extends BaseContract {
  ...
  functions: {
    ...
    getPoolPosition(
      nftID: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[PoolPositionStructOutput] & { pt: PoolPositionStructOutput }>;

    getPosition(
      positionID: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[DebtPositionStructOutput] & { acct: DebtPositionStructOutput }>;

    getRewardStatus(
      poolID: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[RewardStatusStructOutput] & { rs: RewardStatusStructOutput }>;

    getSystemDebtInfo(
      overrides?: CallOverrides
    ): Promise<[SystemDebtInfoStructOutput]>;
    ...
    setPoolPosition(
      nftID: BigNumberish,
      pt: PoolPositionStruct,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    setPosition(
      positionID: BigNumberish,
      dp: DebtPositionStruct,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
    ...
    setSystemDebtInfo(
      _systemDebtInfo: SystemDebtInfoStruct,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  };
