...
export declare type CalculatedInterestInfoStruct = {
...
export declare type CalculatedInterestInfoStructOutput = [
    BigNumber,
    BigNumber,
    BigNumber,
    BigNumber,
...
export interface MarketTestableInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "updatePositionImpl", values: [DebtPositionStruct, SystemDebtInfoStruct, BigNumberish]): string;
...
export interface MarketTestable extends BaseContract {
    ...
    functions: {
        ...
        calculateInterest(sdi: SystemDebtInfoStruct, periods: BigNumberish, annualInterestRate: BigNumberish, positiveInterestRate: boolean, reserves: BigNumberish, _interestPortionToLenders: BigNumberish, overrides?: CallOverrides): Promise<[
            CalculatedInterestInfoStructOutput
        ] & {
            cii: CalculatedInterestInfoStructOutput;
        }>;
        ...
        updatePositionImpl(_position: DebtPositionStruct, sdi: SystemDebtInfoStruct, timeNow: BigNumberish, overrides?: CallOverrides): Promise<[
            DebtPositionStructOutput,
            BigNumber
        ] & {
            position: DebtPositionStructOutput;
            rewards: BigNumber;
        }>;
    ...
    estimateGas: {
        ...
        calculateInterest(sdi: SystemDebtInfoStruct, periods: BigNumberish, annualInterestRate: BigNumberish, positiveInterestRate: boolean, reserves: BigNumberish, _interestPortionToLenders: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        claimAllRewards(positionIDs: BigNumberish[], ui: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<BigNumber>;
        claimRewards(positionID: BigNumberish, ui: BigNumberish, overrides?: Overrides & {
        ...
        updatePositionImpl(_position: DebtPositionStruct, sdi: SystemDebtInfoStruct, timeNow: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        updatePositionImpl(_position: DebtPositionStruct, sdi: SystemDebtInfoStruct, timeNow: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
