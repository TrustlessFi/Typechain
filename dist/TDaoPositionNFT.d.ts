...
export interface TDaoPositionNFT extends BaseContract {
    ...
    functions: {
        ...
        isApprovedOrOwner(account: string, tokenID: BigNumberish, overrides?: CallOverrides): Promise<[boolean]>;
        mintTo(dest: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        setPositionDescriptor(newDescriptor: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        setPositionDescriptor(newDescriptor: string, overrides?: CallOverrides): Promise<void>;
        supportsInterface(interfaceId: BytesLike, overrides?: CallOverrides): Promise<boolean>;
        symbol(overrides?: CallOverrides): Promise<string>;
        tDao(overrides?: CallOverrides): Promise<string>;
        tokenByIndex(index: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    filters: {
        ...
        PositionDescriptorUpdateAbdicated(): PositionDescriptorUpdateAbdicatedEventFilter;
        "PositionDescriptorUpdated(address)"(newPositionDescriptor?: string | null): PositionDescriptorUpdatedEventFilter;
        PositionDescriptorUpdated(newPositionDescriptor?: string | null): PositionDescriptorUpdatedEventFilter;
    ...
    estimateGas: {
        ...
        isApprovedOrOwner(account: string, tokenID: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        mintTo(dest: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        isApprovedOrOwner(account: string, tokenID: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        mintTo(dest: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<PopulatedTransaction>;
        ...
        positionIDs(account: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        "safeTransferFrom(address,address,uint256)"(from: string, to: string, tokenId: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<PopulatedTransaction>;
        "safeTransferFrom(address,address,uint256,bytes)"(from: string, to: string, tokenId: BigNumberish, _data: BytesLike, overrides?: Overrides & {
