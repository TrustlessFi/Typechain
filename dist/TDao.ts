...
export interface TDaoInterface extends ethers.utils.Interface {
  functions: {
...
export type LockDurationIncreaseEvent = TypedEvent<
  [BigNumber, number],
  { positionNFTTokenID: BigNumber; lockDurationMonths: number }
>;
...
export type TDaoStartedEvent = TypedEvent<[], {}>;
...
export interface TDao extends BaseContract {
  ...
  functions: {
    ...
    getRewards(
      positionNFTTokenIDs: BigNumberish[],
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
    ...
    getRewardsStatus(
      ...
      overrides?: CallOverrides
    ): Promise<[TokenRewardsStatusStructOutput]>;
