...
export interface RatesTestableInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [BigNumberish, InterestRateParametersStruct, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "calculateRewardCount",
    values: [RateDataStruct, BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface RatesTestable extends BaseContract {
  ...
  functions: {
    ...
    calculateRate(
      rate: BigNumberish,
      rp: InterestRateParametersStruct,
      price: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
