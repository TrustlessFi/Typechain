...
var IAuctions__factory = /** @class */ (function () {
    function IAuctions__factory() {
    }
    IAuctions__factory.createInterface = function () {
        return new utils.Interface(_abi);
    };
    IAuctions__factory.connect = function (address, signerOrProvider) {
        return new Contract(address, _abi, signerOrProvider);
    };
    IAuctions__factory.abi = _abi;
    return IAuctions__factory;
}());
export { IAuctions__factory };
