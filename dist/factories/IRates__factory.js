...
var IRates__factory = /** @class */ (function () {
    function IRates__factory() {
    }
    IRates__factory.createInterface = function () {
        return new utils.Interface(_abi);
    };
    IRates__factory.connect = function (address, signerOrProvider) {
        return new Contract(address, _abi, signerOrProvider);
    };
    IRates__factory.abi = _abi;
    return IRates__factory;
}());
export { IRates__factory };
