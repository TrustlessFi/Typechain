...
export declare type MigrateParamsStruct = {
    pair: string;
...
export declare type MigrateParamsStructOutput = [
    string,
    BigNumber,
    number,
    string,
...
export interface V3MigratorInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "migrate", values: [MigrateParamsStruct]): string;
...
export interface V3Migrator extends BaseContract {
    ...
    functions: {
        ...
        migrate(params: MigrateParamsStruct, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        factory(overrides?: CallOverrides): Promise<string>;
        migrate(params: MigrateParamsStruct, overrides?: CallOverrides): Promise<void>;
