...
export type UnderlyingVotingRewardsDistributedEvent = TypedEvent<
  [string, BigNumber],
  { caller: string; proposalID: BigNumber }
>;

export type UnderlyingVotingRewardsDistributedEventFilter =
  TypedEventFilter<UnderlyingVotingRewardsDistributedEvent>;
...
export interface TDaoGovernorAlpha extends BaseContract {
  ...
  getProposalsVoterInfo(
    voter: string,
    overrides?: CallOverrides
  ): Promise<ProposalVoterInfoStructOutput[]>;
  ...
  filters: {
    ...
    "UnderlyingVotingRewardsDistributed(address,uint256)"(
      caller?: string | null,
      proposalID?: BigNumberish | null
    ): UnderlyingVotingRewardsDistributedEventFilter;
