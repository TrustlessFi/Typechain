...
export interface IAccountingInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [IAccounting.SystemDebtInfoStruct]
  ): string;
...
export type UIsApprovedEvent = TypedEvent<[number[]], UIsApprovedEventObject>;
...
export type UIsDisapprovedEvent = TypedEvent<
  [number[]],
...
export interface IAccounting extends BaseContract {
  ...
  functions: {
    ...
    setPoolPosition(
      owner: PromiseOrValue<string>,
      pool: PromiseOrValue<string>,
      pt: IAccounting.PoolPositionStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
    ...
    setSystemDebtInfo(
      _systemDebtInfo: IAccounting.SystemDebtInfoStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  };
